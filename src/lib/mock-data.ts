...
export const MOCK_PLAYERS: Player[] = [
  // Americas
  { id: 'p1', name: 'aspas', team: 'LOUD', region: 'Americas', roles: ['Duelist'] },
  { id: 'p2', name: 'Less', team: 'LOUD', region: 'Americas', roles: ['Initiator'] },
  { id: 'p3', name: 'tuyz', team: 'LOUD', region: 'Americas', roles: ['Controller'] },
  { id: 'p4', name: 'cauanzin', team: 'LOUD', region: 'Americas', roles: ['Sentinel'] },
  { id: 'p5', name: 'TenZ', team: 'Sentinels', region: 'Americas', roles: ['Duelist'] },
  { id: 'p6', name: 'zekken', team: 'Sentinels', region: 'Americas', roles: ['Duelist'] },
  { id: 'p7', name: 'Sacy', team: 'Sentinels', region: 'Americas', roles: ['Initiator'] },
  { id: 'p8', name: 'johnqt', team: 'Sentinels', region: 'Americas', roles: ['Controller'] },
  { id: 'p9', name: 'Demon1', team: 'Evil Geniuses', region: 'Americas', roles: ['Duelist'] },
  { id: 'p10', name: 'Boostio', team: 'Evil Geniuses', region: 'Americas', roles: ['Controller'] },
  { id: 'p11', name: 'supamen', team: 'NRG', region: 'Americas', roles: ['Sentinel'] },
  { id: 'p12', name: 'crashies', team: 'NRG', region: 'Americas', roles: ['Initiator'] },
  { id: 'p13', name: 'FNS', team: 'NRG', region: 'Americas', roles: ['Controller'] },
  { id: 'p14', name: 'Victor', team: 'NRG', region: 'Americas', roles: ['Duelist'] },
  { id: 'p15', name: 'Ethan', team: 'NRG', region: 'Americas', roles: ['Initiator'] },

  // Pacific
  { id: 'p16', name: 'PRX something', team: 'Paper Rex', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p17', name: 'f0rsakeN', team: 'Paper Rex', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p18', name: 'Jinggg', team: 'Paper Rex', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p19', name: 'd4v41', team: 'Paper Rex', region: 'Pacific', roles: ['Initiator'] },
  { id: 'p20', name: 'Mindfreak', team: 'Paper Rex', region: 'Pacific', roles: ['Controller'] },
  { id: 'p21', name: 'MaKo', team: 'DRX', region: 'Pacific', roles: ['Controller'] },
  { id: 'p22', name: 'Rb', team: 'DRX', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p23', name: 'stax', team: 'DRX', region: 'Pacific', roles: ['Initiator'] },
  { id: 'p24', name: 'BuZz', team: 'DRX', region: 'Pacific', roles: ['Sentinel'] },
  { id: 'p25', name: 'Laz', team: 'ZETA DIVISION', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p26', name: 'SugarZ3ro', team: 'ZETA DIVISION', region: 'Pacific', roles: ['Controller'] },

  // EMEA
  { id: 'p27', name: 'Leo', team: 'Fnatic', region: 'EMEA', roles: ['Initiator'] },
  { id: 'p28', name: 'Derke', team: 'Fnatic', region: 'EMEA', roles: ['Duelist'] },
  { id: 'p29', name: 'Boaster', team: 'Fnatic', region: 'EMEA', roles: ['Controller'] },
  { id: 'p30', name: 'Alfajer', team: 'Fnatic', region: 'EMEA', roles: ['Duelist'] },
  { id: 'p31', name: 'Chronicle', team: 'Fnatic', region: 'EMEA', roles: ['Sentinel'] },
  { id: 'p32', name: 'cNed', team: 'Natus Vincere', region: 'EMEA', roles: ['Duelist'] },
  { id: 'p33', name: 'Ange1', team: 'Natus Vincere', region: 'EMEA', roles: ['Controller'] },
  { id: 'p34', name: 'Shao', team: 'Natus Vincere', region: 'EMEA', roles: ['Initiator'] },
  { id: 'p35', name: 'ANGE1', team: 'Team Vitality', region: 'EMEA', roles: ['Controller'] },
  { id: 'p36', name: 'Sayf', team: 'Team Vitality', region: 'EMEA', roles: ['Sentinel'] },
  { id: 'p37', name: 'nAts', team: 'Team Liquid', region: 'EMEA', roles: ['Sentinel'] },

  // China
  { id: 'p38', name: 'ZmjjKK', team: 'EDward Gaming', region: 'China', roles: ['Duelist'] },
  { id: 'p39', name: 'nobody', team: 'EDward Gaming', region: 'China', roles: ['Controller'] },
  { id: 'p40', name: 'Haodong', team: 'EDward Gaming', region: 'China', roles: ['Initiator'] },
  { id: 'p41', name: 'CHICHOO', team: 'EDward Gaming', region: 'China', roles: ['Sentinel'] },
  { id: 'p42', name: 'rin', team: 'FunPlus Phoenix', region: 'China', roles: ['Duelist'] },
  { id: 'p43', name: 'Lysoar', team: 'FunPlus Phoenix', region: 'China', roles: ['Controller'] },
  { id: 'p44', name: 'BERSERKER', team: 'FunPlus Phoenix', region: 'China', roles: ['Initiator'] },
  { id: 'p45', name: 'Nizhaolong', team: 'Bilibili Gaming', region: 'China', roles: ['Duelist'] },
  { id: 'p46', name: 'whzy', team: 'Bilibili Gaming', region: 'China', roles: ['Sentinel'] },
  { id: 'p47', name: 'SkRossi', team: 'Global Esports', region: 'Pacific', roles: ['Duelist'] },
  { id: 'p48', name: 'Monyet', team: 'Team Secret', region: 'Pacific', roles: ['Initiator'] },
];
