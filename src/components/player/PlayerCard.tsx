    ...
    >
      ...
      <div className="p-4 space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[var(--text-muted)] uppercase">{player.role}</span>
        </div>
...
function MediumCard({
  ...
  return (
    <div
      className={`
        flex items-center gap-3 p-3 bg-[var(--bg-secondary)] border border-[var(--border-default)]
...
function CompactCard({
  ...
  return (
    <div
      className={`
        flex items-center gap-3 px-3 py-2 bg-[var(--bg-secondary)] border-b border-[var(--border-subtle)]
        w-full h-12
